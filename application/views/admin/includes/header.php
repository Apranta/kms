...
<html lang="en">
    ...
    <head>
        ...
        <link href="<?= base_url('assets/metronic') ?>/assets/global/plugins/bootstrap-daterangepicker/daterangepicker.min.css" rel="stylesheet" type="text/css" />
