    ...
    <div class="col-md-12">
        <div class="portlet light bordered">
                                <div class="portlet-title">
                                    ...
                                    <div class="actions">
                                        <div class="btn-group">
                                            <a class="btn btn-sm green dropdown-toggle" href="<?= base_url('staff') ?>" > <i class="fa fa-angle-left"></i> Kembali
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                <form action="<?=site_url("staff/edit_user/".$data->id_user)?>" method='post'>
